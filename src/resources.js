export default class Res {
  ...
  static helpText =
    "تقطیع کے دوران ہر لفظ کو ہجّائے کوتاہ اور ہجّائے بلند میں تقسیم کیا جاتا ہے۔ نتائج میں کسی لفظ کے نیچے = کی علامت سے اُس میں شامل ہجّائے بلند کی موجودگی ظاہر ہو گی اور - کی علامت سے ہجّائے کوتاہ کی موجودگی۔ مثلاً لفظ سیف کا وزن =- سے ظاہر کیا جائے گااور لفظ اسد کا وزن -= سے۔";
