export default class Res {
  ...
  static helpText =
    "تقطیع کے دوران ہر لفظ کو ہجّائے کوتاہ اور ہجّائے بلند میں تحلیل کیا جاتا ہے۔ نتائج میں کسی لفظ کے نیچے = کی علامت سے اُس میں شامل ہجّائے بلند کی موجودگی ظاہر ہو گی اور - کی علامت سے ہجّائے کوتاہ کی موجودگی۔ مثلاً لفظ سیف کا وزن =- سے ظاہر کیا جائے گااور لفظ اسد کا وزن -= سے۔";
  ...
  static samples = [
    ...
    "دم رُکا سمجھو اگر دم بھر بھی یہ ساغر رُکا\nمیرا دورِ زندگی ہے یہ جو دورِ جام ہے",
    ...
    "مر مٹے تجھ پہ ہو گیا حاصل\nمُدّعا اپنی زندگانی کا",
    ...
    "دیکھنے میں وہ نگاہِ لطف تھی\nکس سے پوچھیں زخمِ دل کیوں کر کُھلا",
    ...
    "بلائیں تیر اور فلک کماں ہے چلانے والا شۂ شہاں ہے\nاُسی کے زیرِ قدم اماں ہے بس اور کوئی مفر نہیں ہے",
    ...
    "میں ستمِ غیر کا شکوہ کروں\nاور وہ سُن کر کہیں اچّھا کِیا",
    ...
    "ختم سرمایۂ شکیب ہوا\nچھیڑ اب تیری آرزو نہ کرے",
    ...
    "مے کدہ بند ہے دور چلتا نہیں\nدیکھیں کب تک یہ موسم بدلتا نہیں",
